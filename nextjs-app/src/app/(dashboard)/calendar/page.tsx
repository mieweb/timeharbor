    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6">
          ...
          !isSyncing && (
            <div className="text-center py-8 text-base-content/60">
              <div>
                ...
                <button onClick={handleConnect} className="btn btn-primary btn-sm md:btn-md">
                ...
                <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
                  <div className="flex-1 w-full">
                    ...
                    <p className="text-xs md:text-sm text-base-content/70 mb-2">
                      ...
                      <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-1 rounded-full text-xs font-medium ml-2">{event.duration} min</span>
                    </p>
                  </div>
                  <button className="btn btn-xs md:btn-sm btn-primary w-full sm:w-auto">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 md:p-4">
        <div className="flex items-start space-x-3">
          <div className="w-5 h-5 md:w-6 md:h-6 text-blue-600 dark:text-blue-400 mt-0.5">
            <svg fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path>
            </svg>
          </div>
          <div>
            <h4 className="font-medium text-sm md:text-base text-blue-900 dark:text-blue-100 mb-1">Privacy & Security</h4>
